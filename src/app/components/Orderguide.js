...
const Productguide = () => {
    return (
        <>
            <section style={{ marginTop: '-2rem', marginBottom: '-6rem', height:'35rem'}} className=" bg-[url('/AP10.jpg')]  relative z-10 my-4 overflow-hidden pt-20 pb-12 lg:pt-[120px] lg:pb-[90px]">
                    ...
                    <div
                        ...
                        <div style={{ marginTop: '-5rem' }} className=" text-justify  text-white w-full md:w-1/3 space-y-4">
                            <p className='font-light' style={{ marginLeft: 20, marginRight: 20 }}>
                                For order guide is that if you want to order Wall Cladding then you can click on the For Order button and choose good and high quality Wall cladding for your's Office or home.
                                and thank you for connecting us.
                            </p>
                        </div>
                        <div className="mx-auto w-1/2 md:w-1/3">
                            <Link href='/wallcladding/2'>
