    ...
    <>
      <section className=" relative h-screen flex flex-col items-center justify-center text-center text-white py-0 px-3">
        ...
        <div style={{marginTop:'9.5rem'}} className="relative z-10 my-4 video-content space-y-2">
          ...
          <p className=" bg-black bg-opacity-25 p-2 max-w-2xl mb-6 text-white lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400" > checkout to global sales tax compliance, companies around the world use Flowbite to simplify their payment stack.
          </p>
