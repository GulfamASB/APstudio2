...
const Gallary = () => {
  return (
    <>
      <div style={{marginBottom:'-6rem'}} class=" bg-slate-100  container mx-auto px-5 py-2 lg:px-32 lg:pt-12">
      <h1 class="mb-4 text-4xl mb-8 tracking-tight font-extrabold text-center text-gray-900 dark:text-white"> Gallary </h1>
