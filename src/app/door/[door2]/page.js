...
const Doorproduct = () => {
  return (
    <>
         <section style={{marginBottom:'20rem',marginTop: '-3rem'}}  class=" bg-gray-200 object-cover relative  flex flex-col items-center justify-center text-center text-white px-3">
                    <div   class="video-docker absolute top-0 left-0 w-full h-96 overflow-hidden py-12">
                        ...
                        <div class="relative text-white video-content space-y-2">
