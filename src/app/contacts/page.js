...
const Contact = () => {
  ...
  <section style={{marginTop:'-6rem'}} className="mb-32 margin={5}">
    ...
    <div className="container px-6 md:px-12">
      ...
      <p className="mb-8 lg:mb-16 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">If you have any query then you can contect with our team. thank you from A Plus studio.</p>
