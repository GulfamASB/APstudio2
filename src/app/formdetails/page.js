        ...
        <>
            <div>
                <section className="relative h-screen flex flex-col items-center justify-center text-center text-white py-0 px-3">
                    <div className="video-docker absolute top-0 left-0 w-full h-80 overflow-hidden">
                        <video className="min-w-full min-h-full absolute object-cover" src="pro.mp4" type="video/mp4" autoPlay="{true}" muted loop></video>
                        <div style={{ marginTop: '6rem' }} className="relative text-white video-content space-y-2">
            ...
            <div style={{ marginTop: '-32rem' }} className='relative z-10 my-4' >
