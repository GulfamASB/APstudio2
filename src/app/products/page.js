...
const Product = () => {
  ...
  <div class="relative  flex flex-col w-70 overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md">
  <a class="h-70 relative mx-3 mt-3 flex overflow-hidden rounded-xl" href="#">
